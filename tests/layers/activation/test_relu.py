...
def test_ReLU():
    ...
    assert_allclose(out_i, out_t.detach(), rtol=1e-5, err_msg="ReLU forward pass missmatch")
    ...
    assert_allclose(down_i, down_t, rtol=1e-5, err_msg="ReLU backward pass missmatch")